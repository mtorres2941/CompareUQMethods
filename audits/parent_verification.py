"""an earlier revision, Part 1: verify the parent CDF numerically.
...
Writes TABLE_ParentVerification.csv and TABLE_TruncationMass.csv
"""
...
if __name__ == '__main__':
    ...
    write(bs, 'TABLE_ParentVerification.csv')
    ...
    write(tm, 'TABLE_TruncationMass.csv')
