"""an earlier revision, Part 1 items 4, 5 and 6.
...
Writes TABLE_OverlapComparison.csv, TABLE_ModalityComparison.csv,
       TABLE_ModeShares.csv
"""
...
import legacy_generator as legacy
...
if __name__ == '__main__':
    ...
    write(ov_df, 'TABLE_OverlapComparison.csv')
    ...
    write(md, 'TABLE_ModalityComparison.csv')
