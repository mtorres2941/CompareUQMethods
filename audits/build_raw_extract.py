...
outlier rule has ever been applied to it. That is what the empirical arm needs, because
...
TYPE in each category. That definition is reproduced exactly, because this extract
...
def load_store():
    ...
    # this changes the vintage and the cleaning rule, not the population.
...
if __name__ == '__main__':
    ...
    per_cat.to_csv(os.path.join(TABLES, 'TABLE_RawExtractByCategory.csv'),
                   index=False)
