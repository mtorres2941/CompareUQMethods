...
systematically understates it.
    ...
    conda run -n compareuq python audits/stage2a3/q5_dispersion_reach.py
"""
import os
import sys
import warnings
...
from b5_tune_configuration import empirical_arm, sample_config, score  # noqa: E402
...
def main():
    ...
    tab.to_csv(os.path.join(TABLES, 'TABLE_2a3_DispersionReach.csv'), index=False)
